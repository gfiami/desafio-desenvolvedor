...
def process_excel():
    ...
    try:
        ...
        if tckr_symb_filter:
            filtered_data = filtered_data[filtered_data['TckrSymb'] == tckr_symb_filter]

        if rpt_dt_filter:
            filtered_data = filtered_data[pd.to_datetime(filtered_data['RptDt'], errors='coerce') == rpt_dt_filter]
        ...
        # aplicar a paginação após os filtros
